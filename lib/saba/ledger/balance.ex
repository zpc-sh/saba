defmodule Saba.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Saba.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Saba.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Saba.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
