defmodule Saba.Sabha.Crystal do
  use Ash.Resource,
    otp_app: :saba,
    domain: Saba.Sabha,
  ...
  attributes do
    ...
    attribute(:nucleant_ids, {:array, :string}, default: [])
    attribute(:structure, :map, default: %{})
    attribute(:claims, {:array, :string}, default: [])
    attribute(:proofs, {:array, :string}, default: [])
