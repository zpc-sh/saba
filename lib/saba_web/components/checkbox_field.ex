defmodule SabaWeb.Components.CheckboxField do
  @moduledoc """
  SabaWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
