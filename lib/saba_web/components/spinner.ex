defmodule SabaWeb.Components.Spinner do
  @moduledoc """
  The `SabaWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `SabaWeb.Components.Spinner` module enables developers to provide
