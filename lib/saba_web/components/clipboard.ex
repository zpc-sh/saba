defmodule SabaWeb.Components.Clipboard do
  @moduledoc """
  The `SabaWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
