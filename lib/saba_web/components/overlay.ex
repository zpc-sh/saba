defmodule SabaWeb.Components.Overlay do
  @moduledoc """
  The `SabaWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `SabaWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
