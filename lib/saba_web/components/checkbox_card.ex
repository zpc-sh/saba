defmodule SabaWeb.Components.CheckboxCard do
  @moduledoc """
  The `SabaWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
