defmodule SabaWeb.Components.Menu do
  @moduledoc """
  The `SabaWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `SabaWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import SabaWeb.Components.Button, only: [button_link: 1]
