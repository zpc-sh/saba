defmodule SabaWeb.Components.NativeSelect do
  @moduledoc """
  The `SabaWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `SabaWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SabaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SabaWeb.Gettext, "errors", msg, opts)
    end
  end
end
