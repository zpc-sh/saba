defmodule SabaWeb.Components.Tabs do
  @moduledoc """
  `SabaWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import SabaWeb.Components.Badge, only: [badge: 1]
